...
# Thoughts
1.全景图可以理解成从一个固定的位置以水平360度，垂直90度FoV角观测得到的照片，从全景图中采样的nFov图应该无法称作multi-view images，它们之间的基线距离为0。
...
5.同样的输入和输出表示，这篇文章的框架和DreamScene360比较接近。
6.相关工作的3d场景生成这里，写的不全面。
